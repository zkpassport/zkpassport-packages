...
export const DEFAULT_OPRF_PUB_KEY: OPRFPublicKey = {
  x: 18166959201346800007624274454748264099569154910741994195889360204497718998925n,
  y: 17198643698593566948834308934687875815952052155871236424838876937611092999400n,
}
