...
describe("SOD", () => {
  ...
  it("compares the redacted SOD with the original SOD", () => {
    ...
    expect(redactedSODParsed.encapContentInfo.eContent.version).toBe(sod.encapContentInfo.eContent.version)
    expect(redactedSODParsed.encapContentInfo.eContent.hashAlgorithm).toBe(sod.encapContentInfo.eContent.hashAlgorithm)
    ...
    expect(redactedSODParsed.signerInfo.signatureAlgorithm.name).toBe(sod.signerInfo.signatureAlgorithm.name)
