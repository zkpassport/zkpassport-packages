// Inline so the flow never waits on a request to draw itself. Line icons share
// the 24x24 box and currentColor of the ones in the card.
...
/** Spun by `.zkp-flow-spinner`; the faint ring stays put because it is a circle. */
