    ...
    >
      <div className="relative bg-white dark:bg-gray-800 rounded-[calc(0.5rem-1px)] overflow-hidden">
        ...
        >
          ...
          <span className="font-semibold text-sm text-gray-900 dark:text-white flex-shrink-0 [text-shadow:1px_1px_4px_white,1px_1px_1px_white] dark:[text-shadow:1px_1px_4px_#1f2937,1px_1px_1px_#1f2937]">
            {countryName}{" "}
