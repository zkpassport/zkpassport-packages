      ...
      <div className="container mx-auto py-8 px-4 sm:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto mb-8">
          <Card className="flex flex-col">
            <CardHeader>
              ...
              <CardDescription className="text-sm">
                Interactive world map of supported countries
              </CardDescription>
            </CardHeader>
            <CardContent className="flex-grow">
              <p className="text-muted-foreground text-sm sm:text-base">
                Explore countries with supported documents, view coverage levels, and discover newly
                added regions in the registry.
              </p>
            </CardContent>
            <CardFooter>
              <Button
          ...
          <Card className="flex flex-col">
            ...
            <CardContent className="flex-grow">
              <p className="text-muted-foreground text-sm sm:text-base">
                View details of certificates, verify their authenticity, and check their status in
                the registry.
              </p>
            </CardContent>
            <CardFooter>
          ...
          <Card className="flex flex-col">
            ...
            <CardContent className="flex-grow">
              <p className="text-muted-foreground text-sm sm:text-base">
                ...
                certificate counts. Each root captures a snapshot of the registry at a specific
                point in time.
              </p>
            </CardContent>
            <CardFooter>
          ...
          <Card className="flex flex-col">
            ...
            <CardContent className="flex-grow">
              <p className="text-muted-foreground text-sm sm:text-base">
                Explore historical circuit registry merkle roots, their validity periods, and
                circuit counts. Each root captures a snapshot of the registry at a specific point in
                time.
              </p>
            </CardContent>
            <CardFooter>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto"></div>
      </div>
    </div>
  )
}
