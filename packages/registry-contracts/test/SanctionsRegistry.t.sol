...
import "../src/SanctionsRegistry.sol";
...
contract SanctionsRegistryTest is Test {
    ...
    function setUp() public {
        vm.prank(admin);
        registry = new SanctionsRegistry(admin, oracle);
    }
    ...
    function testDeploymentEvent() public {
        ...
        vm.recordLogs();
        vm.prank(admin);
        new SanctionsRegistry(admin, oracle);
